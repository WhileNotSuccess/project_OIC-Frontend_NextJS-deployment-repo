...
export const menu: Record<Language, Record<string, string>> = {
  ...
  [Language.english]: {
    ...
    yjuAdmissionsWebsite: "Yeungjin University Admissions Website",
  },
};
...
> = {
  ...
  [Language.english]: [
    ...
    {
      topMenu: "Yeungjin University Website",
      subMenu: [
        { address: "https://www.yju.ac.kr/kr/index.do", name: "Shortcut" },
      ],
    },
    {
      topMenu: "Yeungjin University Admissions Website",
      subMenu: [
        { address: "https://ipsi.yju.ac.kr/ipsi/index.do", name: "Shortcut" },
      ],
    },
  ],
  [Language.japanese]: [
    ...
    },
    {
      topMenu: "Yeungjin University Website",
      subMenu: [
        { address: "https://www.yju.ac.kr/kr/index.do", name: "ショートカット" },
      ],
    },
    {
      topMenu: "Yeungjin University Admissions Website",
      subMenu: [
        { address: "https://ipsi.yju.ac.kr/ipsi/index.do", name: "ショートカット" },
      ],
    },
  ],
};
