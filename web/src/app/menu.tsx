...
export const smallMenu: Record<Language, Record<string, string>> = {
  ...
  [Language.korean]: {
    introduction: "소개글",
    facultyAndStaffIntroduction: "교직원 소개",
    internationalAgreementsStatus: "국제협약현황",
    contactInformation: "연락처",
    admissionInformation: "입학 안내",
    departmentInformation: "학과 안내",
    campusLife: "캠퍼스 생활",
    studentSupportServices: "학생 지원 서비스",
    dormitoryInformation: "기숙사 정보",
    qna: "QNA",
    globalProgram: "글로벌 프로그램",
    globalFieldStudy: "글로벌 현장학습",
    overseasEmploymentSupporting: "해외취업지원센터",
    notifications: "알림",
    announcements: "공지사항",
    shortcut: "바로가기",
  },
  [Language.japanese]: {
    introduction: "紹介文",
    facultyAndStaffIntroduction: "教職員紹介",
    internationalAgreementsStatus: "国際協定状況",
    contactInformation: "連絡先",
    admissionInformation: "入学案内",
    departmentInformation: "学科案内",
    campusLife: "キャンパスライフ",
    studentSupportServices: "学生支援サービス",
    dormitoryInformation: "寮情報",
    qna: "QNA",
    globalProgram: "グローバルプログラム",
    globalFieldStudy: "グローバル現場学習",
    overseasEmploymentSupporting: "グローバル現場学習",
    notifications: "お知らせ",
    announcements: "通知",
    shortcut: "ショートカット",
  },
  [Language.english]: {
    introduction: "introduction",
    facultyAndStaffIntroduction: "Faculty And Staff Introduction",
    internationalAgreementsStatus: "International Agreements Status",
    ...
    qna: "QNA",
    globalProgram: "Global Program",
    globalFieldStudy: "Global Field Study",
    overseasEmploymentSupporting: "Overseas Employment Supporting",
